...
struct OverlappedSendContext : public OverlappedIOContext, ObjectPool<OverlappedIOContext>
{
...
struct OverlappedRecvContext : public OverlappedIOContext, ObjectPool<OverlappedIOContext>
{
...
struct OverlappedPreRecvContext : public OverlappedIOContext, ObjectPool<OverlappedIOContext>
{
...
struct OverlappedDisconnectContext : public OverlappedIOContext, ObjectPool<OverlappedIOContext>
{
...
struct OverlappedAcceptContext : public OverlappedIOContext, ObjectPool<OverlappedIOContext>
{
...
//아래의 ClientSession은 xnew/xdelete사용 가능하도록 클래스 정의 부분 수정
